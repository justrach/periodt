...
import '../../stateHolders/matrixSelectionHolder.dart';
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final currentMatrix = ref.read(matrixSelectionProvider);
          ...
          children: [
            SafeArea(
              ...
              child: CupertinoSegmentedControl<String>(
                ...
                groupValue: currentMatrix,
                onValueChanged: (value) {
                  ref.read(matrixSelectionProvider.notifier).setMatrix(value);
                },
              ),
            ),
            Expanded(
